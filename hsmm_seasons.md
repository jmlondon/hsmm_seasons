...
## Rgshhs: clipping 9 of 7993 polygons ...
```

![](/home/travis/build/jmlondon/hsmm_seasons/out/hsmm_seasons_files/figure-html/movement-map-1.png)<!-- -->
...
![](/home/travis/build/jmlondon/hsmm_seasons/out/hsmm_seasons_files/figure-html/plot-5-indiv-aic-1.png)<!-- -->

Figure 5: comparison of AIC values from the mhsmm model fit for each deployment and varying numbers of states (3:8)

![](/home/travis/build/jmlondon/hsmm_seasons/out/hsmm_seasons_files/figure-html/plot-6-sum-aic-1.png)<!-- -->
...
------- ---------- --------- --------- -------- ---------- ---------
   1       0.1        30        0,0    poisson   nrows/5       0    

   2       0.1        30        0,0    poisson   nrows/5       0    

   3       0.1        30        0,0    poisson   nrows/5       0    

   4       0.1        30        0,0    poisson   nrows/5       0    

   5       0.1        30        0,0    poisson   nrows/5       0    
--------------------------------------------------------------------
...
![](/home/travis/build/jmlondon/hsmm_seasons/out/hsmm_seasons_files/figure-html/plot-10-1.png)<!-- -->

![](/home/travis/build/jmlondon/hsmm_seasons/out/hsmm_seasons_files/figure-html/plot-11-1.png)<!-- -->

![](/home/travis/build/jmlondon/hsmm_seasons/out/hsmm_seasons_files/figure-html/spatial-dist-states-1.png)<!-- -->
